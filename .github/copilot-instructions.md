...
| Release/image behavior | `.goreleaser.yaml`, `Dockerfile`, `Dockerfile.release`, `Dockerfile.ui`, `Dockerfile.ui.release`, `Makefile`, `.github/workflows/ci.yml`, `.github/workflows/release.yml`, README, `docs/_guide/getting-started.md` |
